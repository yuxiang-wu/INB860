...
#define offlineTimeout 150
#define cruiseTimeout 1000
#define cspeed 40
...
void turnAndMove(short target){
  ...
  control(-10, 10, 0);
  while(compass() - cur_compass < 86){}
  control(0, 0, stoptime);

  control(-cspeed, -cspeed, 10);
